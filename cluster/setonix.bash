...
function RUN_GPU_CHECK {
	...
	y) def CONFOPT "--enable-hip --with-mpi-include=${CRAY_MPICH_DIR}/include --with-mpi-lib=${CRAY_MPICH_DIR}/lib --with-cpp-flags=--offload-arch=gfx90a" ;;
	esac
}
...
def MODULES_BASE "r/4.1.0 rocm/5.0.2"
fix MODULES_ADD ""
fix MODULES_RUN ""
